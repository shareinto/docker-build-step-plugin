...
public class DockerBuilder extends Builder {
    ...
    public DockerBuilder(DockerCommand dockerCmd, String dockerUrl, String dockerVersion) {
...
//        if (getDescriptor().createDockerClient(this.dockerUrl, this.dockerVersion, null) == null) {
...
//        }
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public DescriptorImpl() {
            ...
            try {
                getDockerClient(null, null,dockerUrl,dockerVersion);
            } catch (Exception e) {
                LOGGER.warning("Cannot create Docker client: " + e.getCause());
            }
        }

        public static DockerClient createDockerClient(String dockerUrl, String dockerVersion,
        ...
        public FormValidation doTestConnection(@QueryParameter String dockerUrl, @QueryParameter String dockerVersion) {
            ...
            try {
                DockerClient dockerClient = getDockerClient(null, null, dockerUrl, dockerVersion);
...
//            }
        ...
        public DockerClient getDockerClient(AbstractBuild<?, ?> build, AuthConfig authConfig, String dockerUrl, String dockerVersion) {
